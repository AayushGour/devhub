...
export const CURATED_MODELS: ModelEntry[] = [
  ...
  { id: 'Qwen3.5-4B-q4f16_1-MLC',   label: 'Qwen3.5 4B',   family: 'Qwen3.5', sizeLabel: '4B',   vramMB: 3868, supportsTools: false, contextWindow: 4096 },
  ...
  // SmolLM2
  { id: 'SmolLM2-135M-Instruct-q0f16-MLC',   label: 'SmolLM2 135M', family: 'SmolLM2', sizeLabel: '135M', vramMB: 360,  supportsTools: false, contextWindow: 2048 },
  { id: 'SmolLM2-360M-Instruct-q4f16_1-MLC', label: 'SmolLM2 360M', family: 'SmolLM2', sizeLabel: '360M', vramMB: 376,  supportsTools: false, contextWindow: 2048 },
  { id: 'SmolLM2-1.7B-Instruct-q4f16_1-MLC', label: 'SmolLM2 1.7B', family: 'SmolLM2', sizeLabel: '1.7B', vramMB: 1774, supportsTools: false, contextWindow: 2048 },
  // Gemma
  { id: 'gemma3-1b-it-q4f16_1-MLC',   label: 'Gemma 3 1B', family: 'Gemma', sizeLabel: '1B', vramMB: 711,  supportsTools: false, contextWindow: 4096 },
  { id: 'gemma-2-2b-it-q4f16_1-MLC',  label: 'Gemma 2 2B', family: 'Gemma', sizeLabel: '2B', vramMB: 1895, supportsTools: false, contextWindow: 4096 },
  { id: 'gemma-2-9b-it-q4f16_1-MLC',  label: 'Gemma 2 9B', family: 'Gemma', sizeLabel: '9B', vramMB: 6422, supportsTools: false, contextWindow: 4096 },
  // DeepSeek R1 Distill
  { id: 'DeepSeek-R1-Distill-Qwen-7B-q4f16_1-MLC',  label: 'DeepSeek R1 Qwen 7B',  family: 'DeepSeek', sizeLabel: '7B', vramMB: 5107, supportsTools: false, contextWindow: 4096 },
  { id: 'DeepSeek-R1-Distill-Llama-8B-q4f16_1-MLC', label: 'DeepSeek R1 Llama 8B', family: 'DeepSeek', sizeLabel: '8B', vramMB: 5001, supportsTools: false, contextWindow: 4096 },
  // Mistral / Ministral
  { id: 'Mistral-7B-Instruct-v0.3-q4f16_1-MLC',          label: 'Mistral 7B v0.3', family: 'Mistral', sizeLabel: '7B', vramMB: 4573, supportsTools: false, contextWindow: 4096 },
  { id: 'Ministral-3-3B-Instruct-2512-BF16-q4f16_1-MLC', label: 'Ministral 3B',    family: 'Mistral', sizeLabel: '3B', vramMB: 2864, supportsTools: false, contextWindow: 4096 },
  // OLMo 2
